...
/**
 * This is aspect for logging calls
 * and exceptions in methods from controllers who are
 * located in {@code by.feodorkek.flights.controller} package
 */
@Slf4j
@Aspect
@Component
...
public class ControllersLogAspect {
     ...
     * methods of all classes in the {@code by.feodorkek.flights.controller} package
     * and ignore methods marked with the {@link ExcludeFromAspectLog @ExcludeFromAspectLog} annotation
     */
    private final String pointcutExpression = """
            execution(
                * by.feodorkek.flights.controller..*(..)) &&
     ...
     * from {@code by.feodorkek.flights.controller} package
     * <p>
     * It's calling before methods executing, and if
     * {@code logCalls} value set to {@code true},
     * it execute logCall method in {@link LogController}
     *
